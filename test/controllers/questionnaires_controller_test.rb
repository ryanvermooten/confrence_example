...
class QuestionnairesControllerTest < ActionController::TestCase
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post :create, questionnaire: { age_bracket: @questionnaire.age_bracket, fav_veg: @questionnaire.fav_veg, gender: @questionnaire.gender, name: @questionnaire.name }
    end
  ...
  test "should update questionnaire" do
    patch :update, id: @questionnaire, questionnaire: { age_bracket: @questionnaire.age_bracket, fav_veg: @questionnaire.fav_veg, gender: @questionnaire.gender, name: @questionnaire.name }
    assert_redirected_to questionnaire_path(assigns(:questionnaire))
  end
